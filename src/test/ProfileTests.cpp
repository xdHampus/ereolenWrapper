...
class ProfileTestHelper : public BaseTestHelper {
public:
    static std::vector<ereol::LoanActive> loansMockData;
    static std::vector<ereol::ChecklistItem> checklistMockData;
    static std::vector<ereol::Reservation> reservationsMockData;
    static std::vector<ereol::LoanHistorical> loanHistoryMockData;
...
std::vector<ereol::LoanActive> ProfileTestHelper::loansMockData = {
        {
...
std::vector<ereol::ChecklistItem> ProfileTestHelper::checklistMockData = {
        {
                ereol::LoanIdentifier{
...
std::vector<ereol::Reservation> ProfileTestHelper::reservationsMockData = {
        {
                ereol::LoanIdentifier{
...
std::vector<ereol::LoanHistorical> ProfileTestHelper::loanHistoryMockData = {
        {
                ereol::LoanIdentifier{
